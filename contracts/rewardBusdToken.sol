...
contract BabyPunks is IBEP20, Auth {
  ...
  function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized capGasPrice {
    if(feesLocked) {
